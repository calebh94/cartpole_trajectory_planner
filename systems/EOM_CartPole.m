 function [dXdt, xdot_x, xdot_u] = EOM_CartPole(x, u, cart)
...
if nargout>1
    ...
    f1 = EOM_CartPole(x1,uu,cart);
    f2 = EOM_CartPole(x2,uu,cart);
    ...
    g1 = EOM_CartPole(xx,u1,cart);
    g2 = EOM_CartPole(xx,u2,cart);
